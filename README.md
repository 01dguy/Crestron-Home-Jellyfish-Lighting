...
- Transport remains a scaffold that validates and logs websocket URI/messages.
- Real socket connect/read/write should be implemented in `Jellyfish_Lighting_Transport` and inbound frames should be routed to `HandleInboundWebSocketJson(...)`.
